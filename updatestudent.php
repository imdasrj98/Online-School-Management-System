...
<body>
  ...
  <center>
    ...
    <table class="tblwithhlines">
      <tr>
        <td>ID</td>
        <td><input type="text" name="Registration Number" value="178437">
        </td>
      </tr>
      <tr>
        <td>Name</td>
        <td><input type="text" name="name" value="Debayan Das">
        </td>
      </tr>
      <tr>
        <td>Email</td>
        <td><input type="text" name="email" value="debayan@gmail.com">
        </td>
      </tr>
      <tr>
        <td>Phone</td>
