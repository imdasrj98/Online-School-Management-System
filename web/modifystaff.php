...
<body>
  <br>
<h2 class="h"><center>Update Staff<center></h2>
  <br>
  <center>
...
if(isset($_POST))
{
  ...
  if($result1->num_rows>0)
  {
    ...
    {
?>
  <form action="modifystaff2.php" method="post">
    <tr>
      <td><input type="text" style="font-size:18px;" value=<?php echo $row['id'];?> name="id"></td>
