...
if(isset($_POST))
{
  ...
  $id=$_POST["id"];
  $sql1="SELECT * FROM studentdetail where regno=".$id;
  ...
  if($result1->num_rows>0)
  {
    ...
    {
?>
<form action="modifystudentcheck.php" method="post">
<table class="tblwithhlines">
  <tr>
    <td>Registration Number&nbsp;&nbsp; <td><input type="text" style="font-size:18px;" value=<?php echo $row['regno'];?> name="regno">
  </tr>
  <tr>
  ...
  <tr>
    <td>Blood Group <td><input type="text" style="font-size:18px;" value=<?php echo $row['blood'];?> name="blood">
  </tr>
  <tr>
