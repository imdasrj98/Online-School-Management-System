...
<body>
  ...
  <center>
    ...
    <table class="tblwithhlines">
      <tr>
        <td>ID</td>
        <td><input type="text" name="id" value="153465">
        </td>
      </tr>
      <tr>
        <td>Name</td>
        <td><input type="text" name="name" value="S. Mukherjee">
        </td>
      </tr>
      <tr>
        <td>Email</td>
        <td><input type="text" name="email" value="smukherjee@gmail.com">
        </td>
      </tr>
      <tr>
        <td>Phone</td>
        <td><input type="text" name="phone" value="4684864898">
        </td>
      </tr>
      <tr>
        <td>Cabin</td>
        <td><input type="text" name="cabin" value="A401">
        </td>
      </tr>
      <tr>
        <td>Address</td>
