...
<body>
  <br>
<h2 class="h"><center>Student Details<center></h2>
<?php

if(isset($_POST))
{
  $userid=$_SESSION["user"];
  $sql1="SELECT * FROM studentdetail WHERE regno=".$userid;
...
<center>
  ...
  <table class="tblwithhlines">
    <tr>
      <td>Registration Number&nbsp;&nbsp; <td><input type="text" style="font-size:18px;" value=<?php echo $row['regno'];?>>
    </tr>
    <tr>
    ...
    <tr>
      <td>Blood Group <td><input type="text" style="font-size:18px;" value=<?php echo $row['blood'];?>>
    </tr>
    <tr>
      <td>Address <td><input type="text" style="font-size:18px;" value=<?php echo $row['address'];?>>
    </tr>
    <tr>
      <td colspan="2"><center><input type="submit" style="font-size:18px;" value="EDIT"></center></td>
    </tr>
  </table>
</center>
<?php
